...
API_URL = "http://master:5000/predict"  # URL of your deployed model's API
...
while True:
    ...
    predictions = []
    prediction_times = []  # List to store prediction times for each row
    ...
    try:
        ...
        for sample in json_payload:
            ...
            if "predictions" in result:
                ...
                prediction_time = result["predictions"][0]["prediction_time"]
   ...
   # Save predictions and times
    predictions_df = filtered_data.copy()
    predictions_df["predictions"] = predictions
    predictions_df["prediction_time"] = prediction_times  # Add prediction time column
